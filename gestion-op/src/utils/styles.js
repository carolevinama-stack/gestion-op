...
export const styles = {
  ...
  sidebar: { width: 260, background: 'linear-gradient(180deg, #1B5E20 0%, #2E7D32 100%)', color: 'white', display: 'flex', flexDirection: 'column', height: '100vh', position: 'fixed' },
  ...
  button: { padding: '12px 24px', background: '#2E7D32', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 500 },
  ...
  tabActive: { padding: '12px 24px', cursor: 'pointer', borderBottom: '2px solid #2E7D32', marginBottom: -2, fontSize: 14, fontWeight: 600, color: '#2E7D32' },
