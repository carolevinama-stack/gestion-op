...
export const styles = {
  ...
  sidebar: { width: 260, background: '#5D6C57', color: 'white', display: 'flex', flexDirection: 'column', height: '100vh', position: 'fixed' },
  ...
  button: { padding: '12px 24px', background: '#5D6C57', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 500 },
  ...
  tabActive: { padding: '12px 24px', cursor: 'pointer', borderBottom: '2px solid #5D6C57', marginBottom: -2, fontSize: 14, fontWeight: 600, color: '#5D6C57' },
