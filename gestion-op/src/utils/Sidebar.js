  ...
  return (
    <div style={styles.sidebar}>
      ...
      <nav style={{ flex: 1, padding: '14px 0', overflowY: 'auto' }}>
        ...
        <NavItem id="bordereaux" icon="📨" label="Circuit" currentPage={currentPage} setCurrentPage={setCurrentPage} canAccess={canAccessPage('bordereaux')} />
        <NavItem id="suivi" icon="📊" label="Rapport" currentPage={currentPage} setCurrentPage={setCurrentPage} canAccess={canAccessPage('suivi')} />
