...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .bt-date { text-align: right; font-size: 11px; margin-bottom: 10px; }
  .bt-dest { text-align: right; margin-bottom: 15px; font-size: 11px; line-height: 1.6; }
...
<div class="page-container">
  ...
  <div class="bt-date">Abidjan, le ${bt.dateCreation}</div>
  <div class="bt-dest">
    A ${bt.type === 'CF' ? 'Monsieur le Contrôleur Financier' : "Monsieur l'Agent Comptable"}<br/>
    auprès du ${projet?.nomProjet || 'PIF 2'}<br/>
    <strong>ABIDJAN</strong>
  </div>
  ${bt.observations ? '<div style="margin-bottom:15px;font-size:11px"><strong>Objet :</strong> ' + bt.observations + '</div>' : ''}
  ...
  <div class="footer">
    <div class="sign-block">
      <div class="title">${projet?.titreCoordonnateur || 'LA COORDONNATRICE DU PIF 2'}</div>
      <div class="line"></div>
      <div style="font-size:10px;margin-top:4px;font-weight:bold;text-decoration:underline">${projet?.coordonnateur || ''}</div>
    </div>
    <div class="sign-block">
