...
const Sidebar = () => {
  const { currentPage, setCurrentPage, projet, exerciceActif, user, handleLogout } = useAppContext();
  ...
  return (
    <div style={styles.sidebar}>
      ...
      <nav style={{ flex: 1, padding: '14px 0', overflowY: 'auto' }}>
        ...
        <NavItem id="nouvelOp" icon="➕" label="Nouvel OP" currentPage={currentPage} setCurrentPage={setCurrentPage} />
        ...
        <NavItem id="bordereaux" icon="📨" label="Bordereaux" currentPage={currentPage} setCurrentPage={setCurrentPage} />
        <NavItem id="suivi" icon="🔄" label="Suivi Circuit" currentPage={currentPage} setCurrentPage={setCurrentPage} />
        
        <div style={{ padding: '16px 18px 6px', fontSize: 10, opacity: 0.5, letterSpacing: 1 }}>GESTION</div>
        <NavItem id="budget" icon="💰" label="Budget" currentPage={currentPage} setCurrentPage={setCurrentPage} />
        <NavItem id="beneficiaires" icon="👥" label="Bénéficiaires" currentPage={currentPage} setCurrentPage={setCurrentPage} />
