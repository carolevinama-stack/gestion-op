...
const ROLES = {
  ADMIN: { label: 'Administrateur', color: '#c62828', bg: '#ffebee', icon: '👑', description: 'Accès total + gestion utilisateurs + paramètres' },
  OPERATEUR: { label: 'Opérateur', color: '#e65100', bg: '#fff3e0', icon: '✏️', description: 'Saisie, modification, bordereaux, rapports, bénéficiaires' },
  CONSULTATION: { label: 'Consultation', color: '#616161', bg: '#f5f5f5', icon: '👁️', description: 'Lecture seule — voir sans modifier' }
};
