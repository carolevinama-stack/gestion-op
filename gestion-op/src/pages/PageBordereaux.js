          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '20px 22px' }}>
            {(() => {
              ...
              return <>
                ...
                {/* Archiver (si soldé) */}
                {isSolde && op.statut !== 'ARCHIVE' && <div style={{ background: '#efebe9', borderRadius: 10, padding: 14, marginBottom: 16 }}>
                  <div style={{ background: '#d5f5f0', borderRadius: 8, padding: 10, textAlign: 'center', color: '#0d9488', fontWeight: 700, fontSize: 13, marginBottom: 12 }}>✅ OP entièrement soldé</div>
                  <div style={{ fontSize: 11, fontWeight: 700, color: '#795548', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 }}>📦 Archiver directement</div>
                  <div style={{ marginBottom: 10 }}><label style={{ fontSize: 10, fontWeight: 600, display: 'block', marginBottom: 3 }}>Boîte d'archivage</label>
