...
const PageBordereaux=()=>{
  ...
  const renderSuivi=(differes,rejetes,type='CF',subTab,setSubTab)=><div>
    ...
    {subTab==='DIFFERES'&&<div style={crd}>
      ...
      {selectedOps.length>0&&selectedOps.some(id=>differes.find(o=>o.id===id))&&<div style={{marginTop:12,padding:12,background:P.goldLight,borderRadius:10,display:'flex',gap:12,alignItems:'flex-end
