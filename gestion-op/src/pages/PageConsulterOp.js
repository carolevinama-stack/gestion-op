...
const PageConsulterOp = () => {
  ...
  const handlePrint = () => {
    ...
    const htmlParts = [
      ...
      '.page-container { width: 200mm; min-height: 287mm; margin: 20px auto; background: #fff; padding: 2mm; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.2); }',
      
      '.inner-frame { border: 1.5px solid #000; flex: 1; display: flex; flex-direction: column; }',
      
      '@media print {',
      '  body { background: #fff !important; }',
      '  .toolbar { display: none !important; }',
      '  .page-container { margin: 0 auto !important; box-shadow: none !important; width: 100% !important; min-height: 287mm !important; max-height: 287mm !important; padding: 2mm !important; overflow: hidden !important; page-break-after: avoid !important;}',
      '}',
      ...
      '.field-large{line-height:1.4; word-wrap:break-word; text-align: justify; margin-bottom:6px}', 
      ...
      '<div class="field-large" style="margin-top: 8px;">OBJET DE LA DEPENSE :&nbsp;&nbsp;&nbsp;<span class="field-value">' + (selectedOp.objet || '') + '</span></div>',
