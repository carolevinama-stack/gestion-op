...
<div class="page-container"><div class="inner-frame">
  ...
  // === MODIFICATION N° OP (protégée par mot de passe admin) ===
                ...
                <div style={isReadOnly ? { pointerEvents: 'none', opacity: 0.85 } : {}}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
                    ...
                    <div>
                      ...
                      {selectedOp.creePar && (
                        <div style={{ marginBottom: 16 }}>
                          <label style={{ display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 6, color: '#6c757d' }}>SAISI PAR</label>
                          <input type="text" value={selectedOp.creePar} readOnly style={{ ...styles.input, marginBottom: 0, background: '#f8f9fa' }} />
                        </div>
                      )}
