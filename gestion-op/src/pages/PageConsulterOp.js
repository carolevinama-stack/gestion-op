...
const PageConsulterOp = () => {
  ...
  const handlePrint = () => {
    ...
    const htmlParts = [
      ...
      '.page-container { width: 200mm; min-height: 277mm; margin: 20px auto; background: #fff; padding: 4mm; display: flex; flex-direction: column; box-shadow: 0 4px 15px rgba(0,0,0,0.2); box-sizing: border-box; }',
      ...
      '  .page-container { margin: 0 auto !important; box-shadow: none !important; width: 100% !important; height: auto !important; max-height: 287mm !important; padding: 0 !important; box-sizing: border-box !important; overflow: hidden !important; page-break-after: avoid !important;}',
      '}',
      ...
      '.header-center{width:56%; padding:5px 4px; text-align:center; line-height:1.4}', 
      ...
      '.body-content{padding:10px 15px; border-bottom:1px solid #000; flex: 1; display: flex; flex-direction: column; }', 
      ...
      '.field-large{line-height:1.4; word-wrap:break-word}', 
      '.checkbox-line{display:flex; align-items:center; margin-bottom:10px; font-size:12px}', 
      ...
      '.budget-section{margin-top:10px;}',
      ...
      '.value-box{border:1px solid #000; padding:4px 10px; text-align:right; font-weight:bold; white-space:nowrap; font-size:12px}',
      
      '.separator-line { border-top: 1px solid #000; margin: 10px -15px 5px -15px; }',
      
      '.budget-table{width:100%; border-collapse:collapse; margin-top:5px}',
      '.budget-table td{border:1px solid #000; padding:4px 8px; font-size:11px}',
      ...
      '.sig-box{width:33.33%; min-height:110px; display:flex; flex-direction:column; border-right:1px solid #000}', 
      ...
      '.acquit-box{width:33.33%; min-height:80px; display:flex; flex-direction:column}', 
      ...
      '<div class="field-large" style="margin-bottom: 12px; margin-top: 4px;">OBJET DE LA DEPENSE :&nbsp;&nbsp;&nbsp;<span class="field-value">' + (selectedOp.objet || '') + '</span></div>',
