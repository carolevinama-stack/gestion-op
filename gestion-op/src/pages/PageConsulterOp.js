...
const PageConsulterOp = () => {
  ...
  const handlePrint = () => {
    ...
    const htmlParts = [
      ...
      // ✅ CORRECTION 1 : overflow: hidden ajouté sur page-container
      ...
      '<div class="field-large" style="margin-bottom: 40px; margin-top: 4px; max-height: 45mm; overflow: hidden;">OBJET DE LA DEPENSE :&nbsp;&nbsp;&nbsp;<span class="field-value">' + (selectedOp.objet || '') + '</span></div>',
