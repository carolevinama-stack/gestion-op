...
const PageConsulterOp = () => {
  ...
  const handlePrint = () => {
    ...
    // =========================================================================
    // MODIFICATION CI-DESSOUS : Ajustement pleine largeur et blocage 2e page
    // =========================================================================
    const htmlParts = [
      '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>OP ' + selectedOp.numero + '</title>',
      '<style>',
      '@page{size:A4;margin:5mm}@media print{.toolbar{display:none!important}html,body{height:100%;overflow:hidden!important;background:#fff!important;padding:0!important;margin:0!important}.page-container{box-shadow:none!important;margin:0!important;width:100%!important;max-width:100%!important;min-height:auto!important;height:100%!important;padding:2mm!important}}',
