...
const PageConsulterOp = () => {
  ...
  const handlePrint = () => {
    ...
    const htmlParts = [
      ...
      // MODIF: L'espace vide est maintenant géré par le corps du document, 
      // le .budget-section n'est plus forcé d'être collé en bas
      ...
      // MODIF: Marge simple pour le budget (plus de margin-top: auto)
      ...
      // MODIF: Classe pour la ligne de séparation du budget
      '.separator-line { border-top: 1px solid #000; margin: 15px 0 10px 0; }',
      
      // MODIF: Augmentation des hauteurs des visas et acquit libératoire
      ...
      // MODIF : Vérification stricte pour ne pas doubler le "N°"
      ...
      // MODIF : La ligne de séparation ici
