...
const PageConsulterOp = () => {
  ...
  const handlePrint = () => {
    if (!selectedOp) return;
    const html = buildOpPrintHtml({
      selectedOp,
      ben: selectedBeneficiaire,
      src: currentSourceObj,
      projet,
      exerciceActif,
      selectedRib,
      engAnterieurs: getEngagementsAnterieurs(),
      engActuel: getEngagementActuel(),
      dotation: getDotation(),
      formatMontant,
      escapeHtml,
      LOGO_PIF2,
      ARMOIRIE
