                        ...
                        <div>
                          ...
                          <div style={{ display: 'flex', gap: 4, height: 38, alignItems: 'center' }}>
                            {['ESPECES', 'CHEQUE', 'VIREMENT'].map(mode => {
                              ...
                              return (
                                <div key={mode} onClick={() => isEditMode && setForm({ ...form, modeReglement: mode })} style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '0 10px', height: 38, borderRadius: 6, border: `1.5px solid ${active ? accent : '#e0e0e0'}`, background: active ? accent + '08' : 'white', cursor: isEditMode ? 'pointer' : 'default', boxSizing: 'border-box' }}>
