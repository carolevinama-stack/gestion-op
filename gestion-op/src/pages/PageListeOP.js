                  ...
                  <tbody>
                    {opsSupprimes.map(op => (
                      <tr key={op.id} style={{borderBottom:'1px solid #eee'}}>
                        <td style={{...styles.td, fontFamily:'monospace', fontWeight:700}}>{op.numero}</td>
                        <td style={{...styles.td, color: P.textSec}}>{formatDate(op.updatedAt) || formatDate(op.dateSuppression) || '-'}</td>
                        ...
                        <td style={{...styles.td, color:P.textSec, fontStyle:'italic'}}>{op.motifSuppression || 'N/A'}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
