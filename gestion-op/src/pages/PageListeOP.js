            ...
            <table style={styles.table}>
              ...
              <tbody>
                {displayOps.map((op, idx) => {
                  ...
                  return (
                    <tr key={isRejet ? op.id + '-rejet' : op.id} style={{ cursor: isRejet ? 'default' : 'pointer', background: isRejet ? '#fff5f5' : 'transparent' }} onClick={() => { if (!isRejet) { setConsultOpData(op); setCurrentPage('consulterOp'); } }}>
                      {activeSource === 'ALL' && (
                        <td style={styles.td}>
                          <span style={{ 
                      ...
                      <td style={{ ...styles.td, fontFamily: 'monospace', fontSize: 10, fontWeight: 600, color: isRejet ? '#c62828' : undefined }}>
                        {isRejet ? op.displayNumero : op.numero}
                      </td>
                      <td style={styles.td}>
                        <span style={{
                          background: isRejet ? '#ffebee' : `${typeColors[op.type]}20`,
                      ...
                      <td style={{ ...styles.td, textAlign: 'right', fontFamily: 'monospace', fontWeight: 600, fontSize: 11, color: isRejet ? '#c62828' : undefined }}>
