...
import { collection, doc, addDoc, updateDoc, runTransaction, writeBatch } from 'firebase/firestore';
...
const PageListeOP = () => {
  ...
  // FONCTION POUR L'EXPORT EXCEL RE-AJOUTÉE ICI
  const handleExport = () => {
      ...
      <div style={{ background: '#FFFFFF', padding: '12px 16px', borderRadius: 12, marginBottom: 14, boxShadow: '0 1px 4px rgba(0,0,0,0.03)' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'flex-end' }}>
          ...
          <div style={{ flex: '1 1 110px', minWidth: 0 }}>
            ...
            <select value={filters.type} onChange={(e) => setFilters({ ...filters, type: e.target.value })} style={{ ...styles.input, width: '100%', boxSizing: 'border-box', marginBottom: 0, fontSize: 12 }}>
          ...
          <div style={{ flex: '1 1 120px', minWidth: 0 }}>
            ...
            <select value={filters.statut} onChange={(e) => setFilters({ ...filters, statut: e.target.value })} style={{ ...styles.input, width: '100%', boxSizing: 'border-box', marginBottom: 0, fontSize: 12 }}>
              <option value="">Tous</option>
          ...
          <div style={{ flex: '1 1 110px', minWidth: 0 }}>
            ...
            <input type="date" value={filters.dateDebut} onChange={(e) => setFilters({ ...filters, dateDebut: e.target.value })} style={{ ...styles.input, width: '100%', boxSizing: 'border-box', marginBottom: 0, fontSize: 12 }} />
          </div>
          <div style={{ flex: '1 1 110px', minWidth: 0 }}>
            <label style={{ display: 'block', fontSize: 9.5, fontWeight: 700, marginBottom: 3, color: '#888', textTransform: 'uppercase' }}>Au</label>
            <input type="date" value={filters.dateFin} onChange={(e) => setFilters({ ...filters, dateFin: e.target.value })} style={{ ...styles.input, width: '100%', boxSizing: 'border-box', marginBottom: 0, fontSize: 12 }} />
          </div>
        </div>
      </div>
...
<div class="inner-frame">
  ...
  <div class="acquit-section">
    ...
    <div class="acquit-box">
      ...
      {/* Fonction Export ajoutée juste avant le return JSX */}
      {(() => {
        // Cette fonction handleExport est maintenant bien définie dans le scope et appelée par le bouton
      })()}
    </div>
  );
};
